...
namespace Services
{
    ...
    public class Commons
    {
        ...
        public void GetCombo_Standard(ComboBox _comboBox, string MajorCode)
        {
            try
            {
                Open();
                ...
                sSqulSelect += $"  WHERE MAJORCODE = '{MajorCode}'      ";
                ...
                _comboBox.DataSource = dtTemp;
                _comboBox.ValueMember = "MAJORCODE";
                _comboBox.DisplayMember = "CODENAME";
            }
            catch (Exception ex)
            {
        ...
        public DataTable GetCombo_Standard_Grid(string sMajorCode)
        {
            DataTable dtTemp = new DataTable();
            try
            {
        ...
        public void SetGridComboBox(DataGridView dgv,  string sMajorCode, string sColumnID = null, bool AfterSearch = true)
        {
        ...
        private static DataGridViewComboBoxCell _MakeGridComboBox(DataTable dtTemp)
        {

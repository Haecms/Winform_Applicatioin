...
namespace Services
{
    ...
    public class Commons
    {
        ...
        public static void GetCombo_Standard(string MajorCode, ComboBox TempCombo)
        {
        ...
        public static DataTable GetCombo_Standard_Grid(string MajorCode)
        {
            SqlConnection sCon = new SqlConnection(Commons.strCon);
            DataTable dtTemp = new DataTable();
            try

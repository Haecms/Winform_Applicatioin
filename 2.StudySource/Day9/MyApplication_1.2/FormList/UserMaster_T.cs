...
namespace FormList
{
    public partial class UserMaster_T : Services.BaseChildForm
    {
        ...
        public override void DoDelete()
        {
            ...
            int iRowsIndex = Grid1.CurrentRow.Index;    // 현재 선택한 행의 Index
        ...
        public override void DoSave()
        {
            ...
            try
            {
                ...
                DataTable dtTemp = ((DataTable)Grid1.DataSource).GetChanges();  // 변경된 사항을 dtTemp에 넣어줌
